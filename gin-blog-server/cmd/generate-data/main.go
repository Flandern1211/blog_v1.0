...
func generateDefaultResources(db *gorm.DB) {
	...
	resources := []entity.Resource{
		...
		// 菜单模块
		{Name: "菜单列表", ParentId: parents[4].ID, Url: "/menu/list", Method: "GET"},
		{Name: "新增/编辑菜单", ParentId: parents[4].ID, Url: "/menu", Method: "POST"},
		{Name: "删除菜单", ParentId: parents[4].ID, Url: "/menu", Method: "DELETE"},
		{Name: "菜单选项列表(树形)", ParentId: parents[4].ID, Url: "/menu/option", Method: "GET"},
		{Name: "获取当前用户菜单", ParentId: parents[4].ID, Url: "/menu/user/list", Method: "GET"},
		// 角色模块
		{Name: "角色列表", ParentId: parents[5].ID, Url: "/role/list", Method: "GET"},
		{Name: "新增/编辑角色", ParentId: parents[5].ID, Url: "/role", Method: "POST"},
		{Name: "删除角色", ParentId: parents[5].ID, Url: "/role", Method: "DELETE"},
		{Name: "角色选项列表", ParentId: parents[5].ID, Url: "/role/option", Method: "GET"},
		// 资源模块
		{Name: "资源列表", ParentId: parents[6].ID, Url: "/resource/list", Method: "GET"},
		{Name: "新增/编辑资源", ParentId: parents[6].ID, Url: "/resource", Method: "POST"},
		{Name: "删除资源", ParentId: parents[6].ID, Url: "/resource", Method: "DELETE"},
		{Name: "资源选项列表(树形)", ParentId: parents[6].ID, Url: "/resource/option", Method: "GET"},
		{Name: "修改资源匿名访问", ParentId: parents[6].ID, Url: "/resource/anonymous", Method: "PUT"},
		// 评论模块
		{Name: "评论列表", ParentId: parents[7].ID, Url: "/comment/list", Method: "GET"},
		{Name: "删除评论", ParentId: parents[7].ID, Url: "/comment", Method: "DELETE"},
		{Name: "修改评论审核", ParentId: parents[7].ID, Url: "/comment/review", Method: "PUT"},
		// 留言模块
		{Name: "留言列表", ParentId: parents[8].ID, Url: "/message/list", Method: "GET"},
		{Name: "删除留言", ParentId: parents[8].ID, Url: "/message", Method: "DELETE"},
		{Name: "修改留言审核", ParentId: parents[8].ID, Url: "/message/review", Method: "PUT"},
		// 文件模块
		{Name: "文件上传", ParentId: parents[9].ID, Url: "/upload", Method: "POST"},
		// 博客信息模块
		{Name: "获取博客设置", ParentId: parents[10].ID, Url: "/setting/blog-config", Method: "GET"},
		{Name: "获取关于我", ParentId: parents[10].ID, Url: "/setting/about", Method: "GET"},
		{Name: "修改博客设置", ParentId: parents[10].ID, Url: "/setting/blog-config", Method: "PUT"},
		{Name: "修改关于我", ParentId: parents[10].ID, Url: "/setting/about", Method: "PUT"},
		{Name: "获取后台首页信息", ParentId: parents[10].ID, Url: "/home", Method: "GET"},
		// 用户信息模块
		{Name: "用户列表", ParentId: parents[11].ID, Url: "/user/list", Method: "GET"},
		{Name: "获取当前用户信息", ParentId: parents[11].ID, Url: "/user/info", Method: "GET"},
		{Name: "修改用户信息", ParentId: parents[11].ID, Url: "/user", Method: "PUT"},
		{Name: "获取在线用户列表", ParentId: parents[11].ID, Url: "/user/online", Method: "GET"},
		{Name: "强制离线用户", ParentId: parents[11].ID, Url: "/user/offline", Method: "DELETE"},
		{Name: "修改当前用户密码", ParentId: parents[11].ID, Url: "/user/current/password", Method: "PUT"},
		{Name: "修改当前用户信息", ParentId: parents[11].ID, Url: "/user/current", Method: "PUT"},
		{Name: "修改用户禁用", ParentId: parents[11].ID, Url: "/user/disable", Method: "PUT"},
		// 操作日志模块
